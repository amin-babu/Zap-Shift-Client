          ...
          <tbody>
            {
              parcels.map((parcel, index) => (
                <tr key={parcel._id}>
                  ...
                  <td>
                    <button onClick={() => openAssignRiderModal(parcel)} className="btn btn-primary text-secondary">Find Riders</button>
                  </td>
                </tr>
              ))
            }
                    ...
                    <tr key={rider._id}>
                      ...
                      <td>
                        <button
                          ...
                          className='btn btn-primary text-secondary'>Assign</button>
                      </td>
                    </tr>
                  ))
                }
